notepad docs/alur-aplikasi.md

```



Nanti Notepad akan terbuka, isi dengan ini:
...
MediPOS adalah aplikasi kasir apotek berbasis web 

yang memudahkan proses transaksi penjualan obat.
...
2\. Pilih obat dari dropdown katalog

3\. Masukkan jumlah pembelian

4\. Klik "Masukkan Keranjang"

5\. Sistem otomatis menghitung subtotal dan diskon 10% 

&nbsp;  jika total belanja diatas Rp 100.000

6\. Pilih metode pembayaran (Tunai/Non Tunai)

7\. Klik "Proses Pembayaran"

8\. Modal sukses menampilkan ringkasan transaksi
...
Setelah diisi, Save (Ctrl+S) lalu tutup Notepad. Screenshot hasilnya ya! 😊bisakah buat lebih lengkap untuk alur nya?10:33 PMTentu! Ini versi lengkapnya, isi di Notepad:
...
MediPOS adalah aplikasi kasir apotek berbasis web yang 

memudahkan proses transaksi penjualan obat secara cepat, 

akurat, dan efisien. Aplikasi ini dirancang untuk kasir 

apotek dalam mengelola transaksi harian.
